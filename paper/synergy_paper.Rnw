...
%
However, for many participants, the RMSE approached the standard deviation of the frame-to-frame finite differences in constriction degree.
%
...
setwd(file.path("..","analysis","scripts"))
...
repeatability
(range: \numrange{\Sexpr{minICCs[bilabial_idx]}}{\Sexpr{maxICCs[bilabial_idx]}},
median: \num{\Sexpr{medICCs[bilabial_idx]}}). 
%
% alveolar place
% 
...
repeatability
(range: \numrange{\Sexpr{minICCs[alveolar_idx]}}{\Sexpr{maxICCs[alveolar_idx]}},
median: \num{\Sexpr{medICCs[alveolar_idx]}}). 
%
% palatal place
%
...
repeatability
(range: \numrange{\Sexpr{minICCs[palatal_idx]}}{\Sexpr{maxICCs[palatal_idx]}},
median: \num{\Sexpr{medICCs[palatal_idx]}}). 
%
% velar place
%
The velar place had
...
repeatability
(range: \numrange{\Sexpr{minICCs[velar_idx]}}{\Sexpr{maxICCs[velar_idx]}},
median: \num{\Sexpr{medICCs[velar_idx]}}). 
%
% pharyngeal place
%
...
repeatability
(range: \numrange{\Sexpr{minICCs[pharyngeal_idx]}}{\Sexpr{maxICCs[pharyngeal_idx]}},
median: \num{\Sexpr{medICCs[pharyngeal_idx]}}). 
...
The distribution of the articulator synergy biomarker at the velar place had small dispersion about a distinct peak at around \SI{10}{\percent} 
%
(median: \SI{\Sexpr{signif(
100*median(with(tab,bm[tv==4])),
2)}}{\percent}, inter-quartile range: \SIrange{\Sexpr{signif(
100*quantile((with(tab,bm[tv==4])),0.25),
2)}}{\Sexpr{signif(
100*quantile((with(tab,bm[tv==4])),0.75),
2)}}{\percent}).
%
In contrast, the distribution of articulator synergy biomarkers had greater dispersion at the bilabial place
%
(median: \SI{\Sexpr{signif(
100*median(with(tab,bm[tv==1])),
2)}}{\percent}, inter-quartile range: \SIrange{\Sexpr{signif(
100*quantile((with(tab,bm[tv==1])),0.25),
2)}}{\Sexpr{signif(
100*quantile((with(tab,bm[tv==1])),0.75),
2)}}{\percent}), 
%
alveolar place 
%
(median: \SI{\Sexpr{signif(
100*median(with(tab,bm[tv==2])),
2)}}{\percent}, inter-quartile range: \SIrange{\Sexpr{signif(
100*quantile((with(tab,bm[tv==2])),0.25),
2)}}{\Sexpr{signif(
100*quantile((with(tab,bm[tv==2])),0.75),
2)}}{\percent}), 
%
palatal place
%
(median: \SI{\Sexpr{signif(
100*median(with(tab,bm[tv==3])),
2)}}{\percent}, inter-quartile range: \SIrange{\Sexpr{signif(
100*quantile((with(tab,bm[tv==3])),0.25),
2)}}{\Sexpr{signif(
100*quantile((with(tab,bm[tv==3])),0.75),
2)}}{\percent}), 
%
and pharyngeal place
%
(median: \SI{\Sexpr{signif(
100*median(with(tab,bm[tv==5])),
2)}}{\percent}, inter-quartile range: \SIrange{\Sexpr{signif(
100*quantile((with(tab,bm[tv==5])),0.25),
2)}}{\Sexpr{signif(
100*quantile((with(tab,bm[tv==5])),0.75),
2)}}{\percent}).
...
%
\SI{\Sexpr{signif(
100*summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$coefficients["tv1"],
2)
}}{\percent} 
less at the velar place compared to the bilabial place
($z=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$tstat["tv1"],
2)
}$, $p=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$pvalues[1],
2)
}
$),
%
...
%
\SI{\Sexpr{signif(
100*summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$coefficients["tv2"],
2)
}}{\percent} 
less at the velar place compared to the alveolar place
($z=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$tstat["tv2"],
2)
}$, $p=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$pvalues[2],
2)
}
$),
%
...
%
\SI{\Sexpr{signif(
100*summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$coefficients["tv3"],
2)
}}{\percent} 
less at the velar place compared to the palatal place
($z=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$tstat["tv3"],
2)
}$, $p=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$pvalues[3],
2)
}
$),
%
...
%
\SI{\Sexpr{signif(
100*summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$coefficients["tv5"],
2)
}}{\percent} 
less at the velar place compared to the pharyngeal place
($z=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$tstat["tv5"],
2)
}$, $p=
\Sexpr{signif(
summary(glht(m0,linfct=c("tv1 = 0","tv2 = 0","tv3 = 0","tv5 = 0")))$test$pvalues[4],
2)
}
$).
%
The jaw contributed significantly more to constrictions at the alveolar and pharyngeal places compared to constrictions at the velar place.
%
