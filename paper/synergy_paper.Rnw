...
Section~\ref{sec:articulator_synergy_biomarker} defines the articulator synergy biomarker. It evaluates the precision articulator synergy biomarker with respect to bias and precision. 
