...
\bibitem[{Craig(2005)}]{craig2005introduction}
...
\bibinfo{author}{Dawson, K.~M.}, \bibinfo{author}{Tiede, M.~K.},  and
  \bibinfo{author}{Whalen, D.~H.} (\textbf{\bibinfo{year}{2016}}).
...
\bibitem[{Guenther(1995)}]{guenther1995speech}
\bibinfo{author}{Guenther, F.~H.} (\textbf{\bibinfo{year}{1995}}).
  \enquote{\bibinfo{title}{Speech sound acquisition, coarticulation, and rate
  effects in a neural network model of speech production.}}
  \bibinfo{journal}{Psychological review} \textbf{102}(3),
  \bibinfo{pages}{594}, \dodoi{10.1037/0033-295X.102.3.594}.

\bibitem[{Guenther(2016)}]{guenther2016neural}
\bibinfo{author}{Guenther, F.~H.} (\textbf{\bibinfo{year}{2016}}).
  \emph{\bibinfo{title}{Neural Control of Speech}}, \bibinfo{edition}{1} ed.
  (\bibinfo{publisher}{MIT Press}, \bibinfo{address}{Cambridge, MA}).

\bibitem[{Harris and Wolpert(1998)}]{harris1998signal}
\bibinfo{author}{Harris, C.~M.},  and \bibinfo{author}{Wolpert, D.~M.}
  (\textbf{\bibinfo{year}{1998}}). \enquote{\bibinfo{title}{Signal-dependent
  noise determines motor planning}} \bibinfo{journal}{Nature} \textbf{394},
  \bibinfo{pages}{780--784}, \dodoi{10.1038/29528}.

\bibitem[{Herbort \emph{et~al.}(2010)Herbort, Butz, and
  Pedersen}]{herbort2010sure}
\bibinfo{author}{Herbort, O.}, \bibinfo{author}{Butz, M.~V.},  and
  \bibinfo{author}{Pedersen, G.} (\textbf{\bibinfo{year}{2010}}).
  \enquote{\bibinfo{title}{The {SURE\_REACH} model for motor learning and
  control of a redundant arm: From modeling human behavior to applications in
  robotics}} in \emph{\bibinfo{booktitle}{From Motor Learning to Interaction
  Learning in Robots}}, edited by \bibinfo{editor}{O.~Sigaud} and
  \bibinfo{editor}{J.~Peters}, \bibinfo{volume}{\textbf{264}} of
  \emph{\bibinfo{series}{Studies in Computational Intelligence}},
  \bibinfo{edition}{1} ed. (\bibinfo{publisher}{Springer Verlag},
  \bibinfo{address}{Berlin, Heidelberg}), Chap.~\bibinfo{chapter}{5}, pp.
  \bibinfo{pages}{85--106}, \bibinfo{note}{{ISBN} 978-3-642-05180-7}.

\bibitem[{Hothorn \emph{et~al.}(2008)Hothorn, Bretz, and
  Westfall}]{hothorn2008simultaneous}
\bibinfo{author}{Hothorn, T.}, \bibinfo{author}{Bretz, F.},  and
  \bibinfo{author}{Westfall, P.} (\textbf{\bibinfo{year}{2008}}).
  \enquote{\bibinfo{title}{Simultaneous inference in general parametric
  models}} \bibinfo{journal}{Biometrical Journal} \textbf{50}(3),
  \bibinfo{pages}{346--363}, \dodoi{10.1002/bimj.200810425}.

\bibitem[{Houde and Nagarajan(2011)}]{houde2011speech}
\bibinfo{author}{Houde, J.~F.},  and \bibinfo{author}{Nagarajan, S.~S.}
  (\textbf{\bibinfo{year}{2011}}). \enquote{\bibinfo{title}{Speech production
  as state feedback control}} \bibinfo{journal}{Frontiers in Human
  Neuroscience} \textbf{5}, \bibinfo{pages}{1--14},
  \dodoi{10.3389/fnhum.2011.00082}.

\bibitem[{Jackson and Singampalli(2009)}]{jackson2009statistical}
\bibinfo{author}{Jackson, P.~J.},  and \bibinfo{author}{Singampalli, V.~D.}
  (\textbf{\bibinfo{year}{2009}}). \enquote{\bibinfo{title}{Statistical
  identification of articulation constraints in the production of speech}}
  \bibinfo{journal}{Speech Communication} \textbf{51}(8),
  \bibinfo{pages}{695--710}, \dodoi{10.1016/j.specom.2009.03.007}.
...
\bibitem[{Kessler \emph{et~al.}(2015)Kessler, Barnhart, Buckler, Choudhury,
  Kondratovich, Toledano, Guimaraes, Filice, Zhang, Sullivan, and {QIBA
  Terminology Working Group}}]{kessler2015emerging}
\bibinfo{author}{Kessler, L.~G.}, \bibinfo{author}{Barnhart, H.~X.},
  ...
  \bibinfo{author}{Zhang, Z.}, \bibinfo{author}{Sullivan, D.~C.},  and
  \bibinfo{author}{{QIBA Terminology Working Group}}
...
\bibitem[{Lancia and Rosenbaum(2018)}]{lancia2018coupling}
\bibinfo{author}{Lancia, L.},  and \bibinfo{author}{Rosenbaum, B.}
  (\textbf{\bibinfo{year}{2018}}). \enquote{\bibinfo{title}{Coupling relations
  underlying the production of speech articulator movements and their
  invariance to speech rate}} \bibinfo{journal}{Biological Cybernetics}
  \bibinfo{pages}{253--276}, \dodoi{10.1007/s00422-018-0749-y}.
...
\bibinfo{author}{LeBreton, J.~M.},  and \bibinfo{author}{Senter, J.~L.}
  ...
  \bibinfo{pages}{815--852}, \dodoi{10.1177\%2F1094428106296642}.

\bibitem[{Lingala \emph{et~al.}(2017)Lingala, Zhu, Kim, Toutios, Narayanan, and
  Nayak}]{lingala2017fast}
\bibinfo{author}{Lingala, S.~G.}, \bibinfo{author}{Zhu, Y.},
  \bibinfo{author}{Kim, Y.-C.}, \bibinfo{author}{Toutios, A.},
  \bibinfo{author}{Narayanan, S.},  and \bibinfo{author}{Nayak, K.~S.}
  (\textbf{\bibinfo{year}{2017}}). \enquote{\bibinfo{title}{A fast and flexible
  mri system for the study of dynamic vocal tract shaping}}
  \bibinfo{journal}{Magnetic resonance in medicine} \textbf{77}(1),
  \bibinfo{pages}{112--125}.

\bibitem[{Lloyd \emph{et~al.}(2012)Lloyd, Stavness, and
  Fels}]{lloyd2012artisynth}
\bibinfo{author}{Lloyd, J.~E.}, \bibinfo{author}{Stavness, I.},  and
  \bibinfo{author}{Fels, S.} (\textbf{\bibinfo{year}{2012}}).
  \enquote{\bibinfo{title}{Artisynth: A fast interactive biomechanical modeling
  toolkit combining multibody and finite element simulation}} in
  \emph{\bibinfo{booktitle}{Soft tissue biomechanical modeling for computer
  assisted surgery}} (\bibinfo{publisher}{Springer Verlag},
  \bibinfo{address}{Berlin, Heidelberg}), pp. \bibinfo{pages}{355--394},
  \dodoi{10.1007/8415_2012_126}.

\bibitem[{Maeda(1990)}]{maeda1990compensatory}
\bibinfo{author}{Maeda, S.} (\textbf{\bibinfo{year}{1990}}).
  \enquote{\bibinfo{title}{Compensatory articulation during speech: Evidence
  from the analysis and synthesis of vocal-tract shapes using an articulatory
  model}} in \emph{\bibinfo{booktitle}{Speech Production and Speech Modelling}}
  (\bibinfo{publisher}{Springer Verlag}, \bibinfo{address}{Berlin,
  Heidelberg}), pp. \bibinfo{pages}{131--149},
  \dodoi{10.1007/978-94-009-2037-8_6}.

\bibitem[{McGowan and Berger(2009)}]{mcgowan2009acoustic}
\bibinfo{author}{McGowan, R.~S.},  and \bibinfo{author}{Berger, M.~A.}
  (\textbf{\bibinfo{year}{2009}}).
  \enquote{\bibinfo{title}{Acoustic-articulatory mapping in vowels by locally
  weighted regression}} \bibinfo{journal}{The Journal of the Acoustical Society
  of America} \textbf{126}(4), \bibinfo{pages}{2011--2032},
  \dodoi{10.1121/1.3184581}.

\bibitem[{Narayanan \emph{et~al.}(2014)Narayanan, Toutios, Ramanarayanan,
  Lammert, Kim, Lee, Nayak, Kim, Zhu, Goldstein, Byrd, Bresch, Ghosh,
  Katsamanis, and Proctor}]{narayanan2014real}
\bibinfo{author}{Narayanan, S.}, \bibinfo{author}{Toutios, A.},
  ...
  \bibinfo{author}{Bresch, E.}, \bibinfo{author}{Ghosh, P.},
  \bibinfo{author}{Katsamanis, A.},  and \bibinfo{author}{Proctor, M.}
...
\bibinfo{author}{{R Development Core Team}} (\textbf{\bibinfo{year}{2008}}).
  ...
  \bibinfo{address}{Vienna, Austria}, \dourl{www.R-project.org},
  \bibinfo{note}{{ISBN} 3-900051-07-0}.

\bibitem[{Ramanarayanan \emph{et~al.}(2016)Ramanarayanan, Parrell, Goldstein,
  Nagarajan, and Houde}]{Ramanarayanan+2016}
\bibinfo{author}{Ramanarayanan, V.}, \bibinfo{author}{Parrell, B.},
  \bibinfo{author}{Goldstein, L.}, \bibinfo{author}{Nagarajan, S.},  and
  \bibinfo{author}{Houde, J.} (\textbf{\bibinfo{year}{2016}}).
  \enquote{\bibinfo{title}{A new model of speech motor control based on task
  dynamics and state feedback}} in \emph{\bibinfo{booktitle}{Interspeech
  2016}}, pp. \bibinfo{pages}{3564--3568},
  \dodoi{10.21437/Interspeech.2016-1499}.

\bibitem[{Saltzman and Kelso(1987)}]{saltzman1987skilled}
\bibinfo{author}{Saltzman, E.},  and \bibinfo{author}{Kelso, J. A.~S.}
  ...
  \textbf{94}(1), \bibinfo{pages}{84--106}, \dodoi{10.1037/0033-295X.94.1.84}.
...
\bibitem[{Scholz and Sch{\"o}ner(1999)}]{scholz1999uncontrolled}
\bibinfo{author}{Scholz, J.~P.},  and \bibinfo{author}{Sch{\"o}ner, G.}
  (\textbf{\bibinfo{year}{1999}}). \enquote{\bibinfo{title}{The uncontrolled
  manifold concept: identifying control variables for a functional task}}
  \bibinfo{journal}{Experimental Brain Research} \textbf{126}(3),
  \bibinfo{pages}{289--306}, \dodoi{10.1007/s002210050738}.

\bibitem[{Scholz and Sch{\"o}ner(2014)}]{scholz2014use}
\bibinfo{author}{Scholz, J.~P.},  and \bibinfo{author}{Sch{\"o}ner, G.}
  (\textbf{\bibinfo{year}{2014}}). \enquote{\bibinfo{title}{Use of the
  uncontrolled manifold ({UCM}) approach to understand motor variability, motor
  equivalence, and self-motion}} in \emph{\bibinfo{booktitle}{Progress in Motor
  Control}}, edited by \bibinfo{editor}{M.~Levin},
  \bibinfo{volume}{\textbf{826}} of \emph{\bibinfo{series}{Advances in
  Experimental Medicine and Biology}} (\bibinfo{publisher}{Springer Verlag},
  \bibinfo{address}{Berlin, Heidelberg}), pp. \bibinfo{pages}{91--100},
  \dodoi{10.1007/978-1-4939-1338-1_7}.
...
\bibitem[{Shadmehr \emph{et~al.}(2010)Shadmehr, Smith, and
  Krakauer}]{shadmehr2010error}
\bibinfo{author}{Shadmehr, R.}, \bibinfo{author}{Smith, M.~A.},  and
  \bibinfo{author}{Krakauer, J.~W.} (\textbf{\bibinfo{year}{2010}}).
  \enquote{\bibinfo{title}{Error correction, sensory prediction, and adaptation
  in motor control}} \bibinfo{journal}{Annual Review of Neuroscience}
  \textbf{33}, \bibinfo{pages}{89--108},
  \dodoi{10.1146/annurev-neuro-060909-153135}.
...
\bibinfo{author}{Simko, J.},  and \bibinfo{author}{Cummins, F.}
  ...
  \bibinfo{pages}{1229--1246}, \dodoi{10.1037/a0020490}.
...
\bibitem[{Sternad \emph{et~al.}(2010)Sternad, Park, M{\"u}ller, and
  Hogan}]{sternad2010coordinate}
\bibinfo{author}{Sternad, D.}, \bibinfo{author}{Park, S.-W.},
  \bibinfo{author}{M{\"u}ller, H.},  and \bibinfo{author}{Hogan, N.}
  (\textbf{\bibinfo{year}{2010}}). \enquote{\bibinfo{title}{Coordinate
  dependence of variability analysis}} \bibinfo{journal}{PLoS Computational
  Biology} \textbf{6}(4), \bibinfo{pages}{e1000751},
  \dodoi{10.1371/journal.pcbi.1000751}.

\bibitem[{Sullivan \emph{et~al.}(2015)Sullivan, Obuchowski, Kessler, Raunig,
  Gatsonis, Huang, Kondratovich, McShane, Reeves, Barboriak, Guimaraes, and
  Wahl}]{sullivan2015metrology}
\bibinfo{author}{Sullivan, D.~C.}, \bibinfo{author}{Obuchowski, N.~A.},
  ...
  \bibinfo{author}{Guimaraes, A.~R.},  and \bibinfo{author}{Wahl, R.~L.}
  (\textbf{\bibinfo{year}{2015}}). \enquote{\bibinfo{title}{Metrology standards
  for quantitative imaging biomarkers}} \bibinfo{journal}{Radiology}
  \textbf{277}(3), \bibinfo{pages}{813--825},
  \dodoi{10.1148/radiol.2015142202}.

\bibitem[{Szabados and Perrier(2016)}]{Szabados+2016}
\bibinfo{author}{Szabados, A.},  and \bibinfo{author}{Perrier, P.}
  (\textbf{\bibinfo{year}{2016}}). \enquote{\bibinfo{title}{Uncontrolled
  manifolds in vowel production: Assessment with a biomechanical model of the
  tongue}} in \emph{\bibinfo{booktitle}{Interspeech 2016}}, pp.
  \bibinfo{pages}{3579--3583}, \dodoi{10.21437/Interspeech.2016-1579}.

\bibitem[{Todorov and Jordan(2002)}]{todorov2002optimal}
\bibinfo{author}{Todorov, E.},  and \bibinfo{author}{Jordan, M.~I.}
  (\textbf{\bibinfo{year}{2002}}). \enquote{\bibinfo{title}{Optimal feedback
  control as a theory of motor coordination}} \bibinfo{journal}{Nature
  Neuroscience} \textbf{5}(11), \bibinfo{pages}{1226--1235},
  \dodoi{10.1038/nn963}.
...
\bibinfo{author}{Toutios, A.},  and \bibinfo{author}{Narayanan, S.~S.}
  ...
  (ICPhS)}},
  \dourl{www.internationalphoneticassociation.org/icphs-proceedings/ICPhS2015/Papers/ICPHS0514.pdf}.
...
\bibinfo{author}{Turvey, M.~T.} (\textbf{\bibinfo{year}{1977}}).
  ...
  to vision}} in \emph{\bibinfo{booktitle}{Perceiving, Acting and Knowing:
  Towards an Ecological Psychology}}, edited by \bibinfo{editor}{R.~Shaw} and
  \bibinfo{editor}{J.~Bransford} (\bibinfo{publisher}{Routledge Taylor \&
  Francis Group}, \bibinfo{address}{London, New York}), pp.
  \bibinfo{pages}{211--266},
  \dourl{www.haskins.yale.edu/sr/sr041/SR041_01.pdf}, \bibinfo{note}{{ISBN}
  978-1-138-68824-7}.
...
\bibinfo{author}{Uecker, M.}, \bibinfo{author}{Ong, F.},
  ...
  Medicine}}, \bibinfo{publisher}{International Society for Magnetic Resonance
  in Medicine},
  \dourl{www.internationalphoneticassociation.org/icphs-proceedings/ICPhS2015/Papers/ICPHS0514.pdf}.

\bibitem[{van Beers(2009)}]{van2009motor}
\bibinfo{author}{van Beers, R.~J.} (\textbf{\bibinfo{year}{2009}}).
  \enquote{\bibinfo{title}{Motor learning is optimally tuned to the properties
  of motor noise}} \bibinfo{journal}{Neuron} \textbf{63}(3),
  \bibinfo{pages}{406--417}, \dodoi{10.1016/j.neuron.2009.06.025}.

\bibitem[{Vatikiotis-Bateson and Ostry(1995)}]{vatikiotis1995analysis}
\bibinfo{author}{Vatikiotis-Bateson, E.},  and \bibinfo{author}{Ostry, D.~J.}
  (\textbf{\bibinfo{year}{1995}}). \enquote{\bibinfo{title}{An analysis of the
  dimensionality of jaw motion in speech}} \bibinfo{journal}{Journal of
  Phonetics} \textbf{23}(1-2), \bibinfo{pages}{101--117},
  \dodoi{10.1016/S0095-4470(95)80035-2}.

\bibitem[{Wood(1979)}]{wood1979radiographic}
\bibinfo{author}{Wood, S.} (\textbf{\bibinfo{year}{1979}}).
  \enquote{\bibinfo{title}{A radiographic analysis of constriction location for
  vowels}} \bibinfo{journal}{Journal of Phonetics} \textbf{7},
  \bibinfo{pages}{25--43}.

\bibitem[{Wu \emph{et~al.}(2014)Wu, Miyamoto, Castro, {\"O}lveczky, and
  Smith}]{wu2014temporal}
\bibinfo{author}{Wu, H.~G.}, \bibinfo{author}{Miyamoto, Y.~R.},
  \bibinfo{author}{Castro, L. N.~G.}, \bibinfo{author}{{\"O}lveczky, B.~P.},
  and \bibinfo{author}{Smith, M.~A.} (\textbf{\bibinfo{year}{2014}}).
  \enquote{\bibinfo{title}{Temporal structure of motor variability is
  dynamically regulated and predicts motor learning ability}}
  \bibinfo{journal}{Nature Neuroscience} \textbf{17}(2),
  \bibinfo{pages}{312--321}, \dodoi{10.1038/nn.3616}.
