...
(coronal inter-quartile range: \SIrange{44}{64}{\percent};
pharyngeal inter-quartile range: \SIrange{17}{37}{\percent}),
...
larger biomarker values than the velar constriction
($z=5.2$, 
$p=\ensuremath{1.8454968\times 10^{-6}}$)
%
and \SI{9.1}{\percent} 
larger biomarker values than the pharyngeal constriction
($z=3.5$, 
...
%
bilabial constriction in 96/96 cases 
(\SI{100}{\percent}), 
%
palatal constriction in 32/96 cases
(\SI{33}{\percent}), 
velar constriction in 88/96 cases 
(\SI{92}{\percent}), 
and constriction pharyngeal in 83/96 cases
(\SI{86}{\percent}).
%
The articulator synergy biomarker was greater for the palatal constriction than for the 
%
velar constriction in 71/96 cases
(\SI{74}{\percent})
and pharyngeal constriction in 65/96 cases
(\SI{68}{\percent}).
%
The articulator synergy biomarker was greater for the pharyngeal constriction than for the 
%
velar constriction in 25/96 cases 
(\SI{26}{\percent}).
%
...
%
The likelihood ratio test indicates that the by-participant random slopes for constriction task are a significant source of variance ($\chi^2(14)= 555.2897865; p = \ensuremath{1.7116449\times 10^{-109}}$).
%
