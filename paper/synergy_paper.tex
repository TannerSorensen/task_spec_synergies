...
%
From the time of constriction onset to the time of maximum constriction, the jaw and tongue produce a narrowing at the palatal place, and constriction degree decreases to a minimum. 
%
After achieving maximum constriction, the jaw and tongue widen the constriction degree at the palatal place, and constriction degree increases.}
...
($z=7$, 
$p=\ensuremath{9.7\times 10^{-12}}$), and
%
% velar vs. palatal
%
\SI{19}{\percent} 
...
($z=4$, 
$p=\ensuremath{5.1\times 10^{-4}}$), and
%
...
\bibinfo{author}{Herbort, O.}, \bibinfo{author}{Butz, M.~V.},  and
  ...
  \enquote{\bibinfo{title}{The sure\_reach model for motor learning and control
...
\bibitem[{Lingala \emph{et~al.}(2016)Lingala, Toutios, T{\"o}ger, Lim, Zhu,
  Kim, Vaz, Narayanan, and Nayak}]{lingala2016state}
\bibinfo{author}{Lingala, S.~G.}, \bibinfo{author}{Toutios, A.},
  \bibinfo{author}{T{\"o}ger, J.}, \bibinfo{author}{Lim, Y.},
  \bibinfo{author}{Zhu, Y.}, \bibinfo{author}{Kim, Y.-C.},
  \bibinfo{author}{Vaz, C.}, \bibinfo{author}{Narayanan, S.},  and
  \bibinfo{author}{Nayak, K.} (\textbf{\bibinfo{year}{2016}}).
  \enquote{\bibinfo{title}{State-of-the-art {MRI} protocol for comprehensive
  assessment of vocal tract structure and function}} in
  \emph{\bibinfo{booktitle}{Interspeech 2016}}, pp. \bibinfo{pages}{475--479},
  \dodoi{10.21437/Interspeech.2016-559}.
...
\bibinfo{author}{Sullivan, D.~C.}, \bibinfo{author}{Obuchowski, N.~A.},
  ...
  \textbf{277}(3), \bibinfo{pages}{813--825}, \dodoi{10.1148/radiol.2015142202}
  \bibinfo{note}{for the RSNA-QIBA Metrology Working Group}.
