...
Do participants have large biomarker values at some places of articulation but small biomarker values at others, 
or does a given participant have on average the same biomarker values across place of articulation?
%
The present study tests whether participants differ in the average biomarker value produced at different places of articulation.
%
The study compares the linear mixed effects model of Section~\ref{sec:taskspec} (cf. Equation~\ref{eq:lmm}) to a reduced model that drops by-participant random slopes for place of articulation using the likelihood ratio test. 
%
The by-participant random slopes for place of articulation is a significant source of variance ($\chi^2(14)= 576.9879695, p = \ensuremath{4.18059\times 10^{-114}}$).
%
This indicates that participants differ in the average biomarker value produced at different places of articulation.
%
The study applies the Mann-Whitney U Test to identify places of articulation that differ in average biomarker value for each participant.
For all participants, the biomarker values at the coronal place of articulation are greater on average than those at the bilabial place (cf. Figure~\ref{fig:consistency}).
For seven of eight participants, the biomarker values at the velar place of articulation are greater on average than those at the bilabial place.
