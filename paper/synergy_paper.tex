...
%
(median: \SI{10}{\percent}, inter-quartile range: \SIrange{6}{13}{\percent}).
%
In contrast, the distribution of articulator synergy biomarkers had greater dispersion at the bilabial place
%
(median: \SI{24}{\percent}, inter-quartile range: \SIrange{9.4}{49}{\percent}), 
%
alveolar place 
%
(median: \SI{55}{\percent}, inter-quartile range: \SIrange{43}{63}{\percent}), 
%
palatal place
%
(median: \SI{26}{\percent}, inter-quartile range: \SIrange{12}{45}{\percent}), 
%
and pharyngeal place
%
(median: \SI{24}{\percent}, inter-quartile range: \SIrange{13}{32}{\percent}).
