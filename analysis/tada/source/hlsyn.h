...
#define L_EPS (0.001) /* cm */
#define FLOAT_EPS (10.0 * FLT_MIN)

#define AN_NO_NASAL_BREAKPOINT (-0.5f) /* sq. mm */
...
#define BRENT_DEFAULT_EPS 3.0e-8f	   /* Machine floating point precision */
...
#define SPEEDSOUND 35400.	/* cm/s */
#define PI 3.14159265359
#define RHO 0.00114		/* g/cm^3 */
#define MU 0.000194  /* dyne sec/cm^4 */
