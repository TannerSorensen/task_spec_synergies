...

{
  ...
  *****/
  ...
  speaker->Lc_ab = 1.f;				/* cm */ /* 2.0 ??? */

  speaker->f1Min = IsMale ? 350.f : 400.f;		/* Hz */
  speaker->f1Max = IsMale ? 500.f : 550.f;		/* Hz */
  ...
  speaker->f3LateralMin = IsMale ? 2700.f : 2900.f;	/* Hz */
  speaker->Kacl=25.f;
  ...
  speaker->f1HiShift = IsMale ? 1080.f : 1280.f;	/* Hz */
  ...
  *****/
  ...
  speaker->anfnTable_fno = 500.f;		/* Hz */
  speaker->anfnTable[0].ANFN_AN = 0.f;	/* sq mm */
  speaker->anfnTable[1].ANFN_AN = 10.f;	/* sq mm */
  speaker->anfnTable[2].ANFN_AN = 20.f;	/* sq mm */
  speaker->anfnTable[3].ANFN_AN = 30.f;	/* sq mm */
  speaker->anfnTable[4].ANFN_AN = 40.f;	/* sq mm */
  speaker->anfnTable[5].ANFN_AN = 50.f;	/* sq mm */
  speaker->anfnTable[6].ANFN_AN = 60.f;	/* sq mm */
  speaker->anfnTable[7].ANFN_AN = 70.f;	/* sq mm */
  speaker->anfnTable[8].ANFN_AN = 80.f;	/* sq mm */

  speaker->anfnTable[0].ANFN_FN = 500.f;	/* Hz */
  speaker->anfnTable[1].ANFN_FN = 580.f;	/* Hz */
  speaker->anfnTable[2].ANFN_FN = 660.f;	/* Hz */
  speaker->anfnTable[3].ANFN_FN = 730.f;	/* Hz */
  speaker->anfnTable[4].ANFN_FN = 780.f;	/* Hz */
  speaker->anfnTable[5].ANFN_FN = 810.f;	/* Hz */
  speaker->anfnTable[6].ANFN_FN = 840.f;	/* Hz */
  speaker->anfnTable[7].ANFN_FN = 870.f;	/* Hz */
  speaker->anfnTable[8].ANFN_FN = 900.f;	/* Hz */
  ...
  *****/
  ...
  speaker->f1LOverATable[0].F1LOVERA_F1 = 180.f;	/* Hz */
  speaker->f1LOverATable[1].F1LOVERA_F1 = 200.f;	/* Hz */
  speaker->f1LOverATable[2].F1LOVERA_F1 = 250.f;	/* Hz */
  speaker->f1LOverATable[3].F1LOVERA_F1 = 300.f;	/* Hz */
  speaker->f1LOverATable[4].F1LOVERA_F1 = 350.f;	/* Hz */
  speaker->f1LOverATable[5].F1LOVERA_F1 = 400.f;	/* Hz */
  speaker->f1LOverATable[6].F1LOVERA_F1 = 450.f;	/* Hz */
  speaker->f1LOverATable[7].F1LOVERA_F1 = 500.f;	/* Hz */
  speaker->f1LOverATable[8].F1LOVERA_F1 = 600.f;	/* Hz */
  speaker->f1LOverATable[9].F1LOVERA_F1 = 700.f;	/* Hz */
  speaker->f1LOverATable[10].F1LOVERA_F1 = 800.f;	/* Hz */

  speaker->f1LOverATable[0].F1LOVERA_LOVERA = 1000.f;	/* 1/cm */
  speaker->f1LOverATable[1].F1LOVERA_LOVERA = 25.f;		/* 1/cm */
  speaker->f1LOverATable[2].F1LOVERA_LOVERA = 20.f;		/* 1/cm */
  speaker->f1LOverATable[3].F1LOVERA_LOVERA = 10.f;		/* 1/cm */
  speaker->f1LOverATable[4].F1LOVERA_LOVERA = 7.f;		/* 1/cm */
  speaker->f1LOverATable[5].F1LOVERA_LOVERA = 5.f;		/* 1/cm */
  speaker->f1LOverATable[6].F1LOVERA_LOVERA = 4.f;		/* 1/cm */
  speaker->f1LOverATable[7].F1LOVERA_LOVERA = 3.f;		/* 1/cm */
  speaker->f1LOverATable[8].F1LOVERA_LOVERA = 2.5f;	/* 1/cm */
  speaker->f1LOverATable[9].F1LOVERA_LOVERA = 2.f;		/* 1/cm */
  speaker->f1LOverATable[10].F1LOVERA_LOVERA = 1.8f;	/* 1/cm */

  speaker->NasalBandwidth = 200.f;	/* Hz */
  ...
  *****/
  ...
  speaker->Cgm = 8.0e-6f;	/* cm^3/dyne was .8 e -7 in Williams (8.0 e -6) */
  ...
  *****/
  ...
  speaker->LabialAB = 50.f;			/* dB */
  speaker->PalVelarA2F = 60.f;		/* dB (or 55) */
  speaker->PalVelarA5F = 40.f;		/* dB */
  speaker->PalVelarA3F = 60.f;		/* dB (or 65) */
  speaker->PalVelar_f2Offset = IsMale ? 1950.f : 2200.f;	/* Hz */
  speaker->PalVelar_f2Overf3_Slope = 0.f;			/* Hz/Hz */
  speaker->LateralA3F = 40.f;		/* dB, male */
  speaker->RetroflexA3F = 50.f;		/* dB, male */
...
/*speaker->KB1 = 15.f;
  ...
  *****/
  ...
  speaker->Lvg = IsMale ?  0.4f : 0.3f; /* cm */
...

{
  ...
  *****/
  ...
  f2MinScaled = (short)(f2Min * Scale + 0.5);
  f2MaxScaled = (short)(f2Max * Scale + 0.5);
  f3Scaled = (short)(f3 * Scale + 0.5);
